...
- Use Conventional Commits and keep every commit focused on one functional change.
- Before handoff, run lint, typecheck, unit tests, Playwright tests, and a production build.
