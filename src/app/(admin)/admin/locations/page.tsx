...
export default async function LocationsPage() {
  ...
  return <main className="admin-shell">
    ...
    <div className="admin-grid">
      <section className="panel"><h2>新增地点</h2><form action={createLocationAction} className="stack-form"><label>地点名称<input name="name" required placeholder="例如：上海影城正门" /></label><div className="form-row"><label>纬度<input name="latitude" type="number" step="any" min="-90" max="90" required placeholder="31.2304" /></label><label>经度<input name="longitude" type="number" step="any" min="-180" max="180" required placeholder="121.4737" /></label></div><label>默认范围（米）<input name="defaultRadiusMeters" type="number" min="50" max="100000" defaultValue="1000" required /></label><button className="button primary" type="submit">保存地点</button></form></section>
